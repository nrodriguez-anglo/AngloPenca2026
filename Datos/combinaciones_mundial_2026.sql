-- Tabla de combinaciones de mejores terceros - Mundial 2026
-- 495 combinaciones posibles (C(12,8) = 495)

CREATE TABLE combinaciones (
    id              INT PRIMARY KEY,
    combinacion     VARCHAR(12) NOT NULL,  -- Letras de los 8 grupos cuyos terceros clasifican
